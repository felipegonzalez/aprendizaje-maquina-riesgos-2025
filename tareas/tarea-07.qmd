---
title: "Tarea 7: más de clasificación binaria"
format: html
---
...
caravan_split = initial_validation_split(caravan, 
  strata = Purchase, prop = c(0.7, 0.2))
caravan_split
```
...
eval_tbl <- tune_grid(flujo_caravan,
                      resamples = validation_set(caravan_split),
                      grid = grid,
...
(hay otras opciones). En este caso, ordenamos 
...
### Curva ROC para el clasificador (OPCIONAL)
...
independiente de cuánto quisieramos qe fuera la sensibilidad
