...
promediando sobre la condicional $\mathbf{y}|\mathbf{x} $:
...
suceder, pues predicciones buenas no deben cambiar dependiendo de la muestra de entrenamiento).
...
modelo está cerca de saturar su capacidad, y no muy lejano a $f_{\lim}$).
