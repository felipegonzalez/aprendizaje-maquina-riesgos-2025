...
### Uso de las predicciones y validación y prueba

Como explicamos, muchas veces tenemos que construir, con datos disponibles, separaciones de los datos en conjuntos de entrenamiento, validación y prueba. Para definir correctamente estos conjuntos, **lo primero tenemos que preguntarnos es cómo se van a utilizar las predicciones una vez que pongamos en producción el modelo**. Una pregunta
útil que podemos hacer al principio es:

- ¿Cuál es la unidad de predicción? ¿Para qué tipo de unidades vamos
a hacer predicciones al poner en producción el modelo?
