...
mejorar el **desempeño** en alguna tarea o toma de decisión. Nos
interesan principalmente aquellas tareas o decisiones que se
toman de manera repetida y donde el costo de cada error es relativamente
bajo. 
...
Aunque es posible extender lo que veremos a contextos más generales, cuando uno
de los tres anteriores requisitos no se cumple es mejor usar o complementar con
otros enfoques.
...
Las razones para no tomar un enfoque de reglas construidas "a mano":
...
pues sólo la conocemos una vez que la venta se hace. Sin embargo,
nos interesa principalemente entender qué sucede cuando las casas se venden
en condiciones normales. Consideramos además
del área habitable, 
...
donde los valores de $a[\textrm{Calidad}] , b[\textrm{Calidad}], c, d$ podríamos estimarlos de
