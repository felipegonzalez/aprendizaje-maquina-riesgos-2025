...
En la actualidad, no es necesario programar los cálculos de *backpropagation* directamente.
Más bien, utilizamos *diferenciación automática* que, considerando la definición
de la red neuronal, automáticamente crea una función que calcula el gradiente, utilizando
la regla de la cadena y la derivada de las funciones básicas.
...
historia <- modelo_red |> fit(
  ...
  batch_size = 30, epochs = 250, verbose = 0)
```
